...
#     column_gradients = {
#         1: {
#             "Неподвижен": ("linear", QColor(0, 0, 0,0), QColor(0, 0, 0,0)),
#             "Движение": ("linear", QColor(6, 157, 101), QColor(4, 120, 80)),
#             "Ошибка": ("radial", QColor(255, 0, 0), QColor(139, 0, 0)),
#             "Пауза": ("linear", QColor(255, 165, 0), QColor(200, 120, 0)),
#             "Ожидание заготовок": ("linear", QColor(30, 144, 255), QColor(0, 100, 200)),
#         },
#         2: {
#             "Ок": ("radial", QColor(0, 100, 0), QColor(0, 150, 80)),
#             "Фрезерование": ("radial", QColor(0, 100, 0), QColor(0, 150, 80)),
#             "Остановлен": ("linear", QColor(220, 20, 60), QColor(178, 34, 34)),
#             "Пауза": ("linear", QColor(255, 165, 0), QColor(200, 120, 0)),
#             "Ожидание": ("linear", QColor(100, 149, 237), QColor(65, 105, 225)),
#             "Ошибка": ("radial", QColor(255, 0, 0), QColor(139, 0, 0)),
#         },
#         3: {
...
#             "Ошибка": ("radial", QColor(255, 0, 0), QColor(139, 0, 0)),
#             "Ожидание": ("linear", QColor(70, 130, 180), QColor(47, 79, 79)),
#             "Отменено": ("linear", QColor(169, 169, 169), QColor(105, 105, 105)),
#             "Пауза": ("linear", QColor(255, 215, 0), QColor(218, 165, 32)),
#         }
#     }
...
#         if column not in self.column_gradients or status_text not in self.column_gradients[column]:
#             super().paint(painter, option, index)
#             return
            
#         gradient_type, color_start, color_end = self.column_gradients[column][status_text]
...
#             "Движение": (QColor(0, 230, 118), QColor(0, 180, 90)),
#             "Ошибка": (QColor(255, 82, 82), QColor(200, 40, 40)),
#             "Пауза": (QColor(255, 193, 7), QColor(230, 160, 0)),
#             "Ожидание заготовок": (QColor(41, 182, 246), QColor(21, 142, 206)),
#         },
#         2: {
#             "Ок": (QColor(102, 187, 106), QColor(76, 157, 80)),
#             "Фрезерование": (QColor(0, 200, 83), QColor(0, 160, 63)),
#             "Остановлен": (QColor(244, 67, 54), QColor(200, 40, 40)),
#             "Пауза": (QColor(255, 193, 7), QColor(230, 160, 0)),
...
#         if (column == 3):
#             self.drawBadgeGradient(column, status_text, painter,option )
#         else:
#             self.drawTextGradient()
...
#     def  drawBadgeGradient(self, column, status_text,painter , option):
...
#     def  drawTextGradient(self, column, status_text,painter , option):
#         gradient_type, color_start, color_end = self.column_gradients[column][status_text]
#         text_color = QColor(255, 255, 255)
